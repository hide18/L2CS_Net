...
def parse_args():
  ...
  parser.add_argument(
    '--alpha', dest='alpha', help='Regression faceres loss coefficient.', default=1, type=float
  )
  parser.add_argument(
    '--beta', dest='beta', help='Regression eyeres loss coefficient.', default=2, type=float
  )
  parser.add_argument(
