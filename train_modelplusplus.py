...
if __name__=='__main__':
  ...
  if dataset=="gaze360":
    ...
    optimizer_gaze = torch.optim.Adam([
      ...
      {'params' : get_ignored_params(left), 'lr' : 0},
      {'params' : get_ignored_params(right), 'lr' : 0},
      {'params' : get_non_ignored_params(face), 'lr' : args.lr},
      {'params' : get_non_ignored_params(left), 'lr' : args.lr},
      {'params' : get_non_ignored_params(right), 'lr' : args.lr},
