...
def getArch_weights(arch, bins):
  if arch == 'ResNet18':
    model = Res(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], 3, bins)
    pre_url = 'https://download.pytorch.org/models/resnet18-5c106cde.pth'
  elif arch == 'ResNet34':
    model = Res(torchvision.models.resnet.BasicBlock, [3, 4, 6, 3], 3, bins)
    pre_url = 'https://download.pytorch.org/models/resnet34-333f7ec4.pth'
  elif arch == 'ResNet101':
    model = Res(torchvision.models.resnet.Botteleneck, [3, 4, 23, 3], 3, bins)
    pre_url = 'https://download.pytorch.org/models/resnet101-5d3b4d8f.pth'
  elif arch == 'ResNet152':
    model = Res(torchvision.models.resnet.Botteleneck, [3, 8, 36, 3], 3, bins)
    pre_url = 'https://download.pytorch.org/models/resnet152-b121ed2d.pth'
  else:
    model = Res(torchvision.models.resnet.Bottleneck, [3, 4, 6, 3], 3, bins)
...
if __name__=='__main__':
  ...
  if dataset=="gaze360":
    ...
    summary_name = '{}_{}'.format('ResNet-gaze360', str(today.strftime('%Y-%-m*%-d_%-H*%-M*%-S')))
