    ...
    with open(os.path.join(valpath, dataset+".log"), 'w') as outfile:
      ...
      for epoch in range(num_epochs):
        ...
        for i, (face, left, right, labels, cont_labels, name) in enumerate(train_loader):
          ...
          #Loss
          loss_gb_pitch = mse_loss(pre_gb_pitch, label_pitch_cont)
          loss_gb_yaw = mse_loss(pre_gb_yaw, label_yaw_cont)
          loss_g_pitch = mse_loss(pre_pitch, label_pitch_cont)
          loss_g_yaw = mse_loss(pre_yaw, label_yaw_cont)
